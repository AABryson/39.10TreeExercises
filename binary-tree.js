...
class BinaryTree {
  ...
  minDepth() {
    ...
    while (nodeQueue.length > 0) {
      ...
      let currentDepth = depthQueue.shift();
  ...
  nextLarger(lowerBound) {
    ...
    let largerNumbers = pathValue.filter(n => n > lowerbound)
//#do I need to use spread???##########################
    let smallestNumber = Math.min(...largerNumbers)
